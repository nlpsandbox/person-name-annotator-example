...
An example implementation of the [NLP Sandbox Person Name Annotator](https://github.com/nlpsandbox/nlpsandbox-schemas/blob/develop/openapi/person-name-annotator/openapi.yaml).
...
We recommend using a Conda environment to install and run the Date Annotator.
    ...
    conda create --name nlp-sandbox-person-name-annotator-example python=3.8.5
    conda activate nlp-sandbox-person-name-annotator-example
...
When running, the Person Name Annotator provides a web interface (http://localhost:8080/api/v1/ui/)
...
and save this file to the root folder of your project.
    ...
    curl -f -O https://sage-bionetworks.github.io/nlp-sandbox-schemas/person-name-annotator/latest/openapi.yaml
...
[NLP Sandbox Person Name Annotator]: https://github.com/nlpsandbox/nlpsandbox-schemas/tree/develop/openapi/person-name-annotator
[NLP Sandbox Peron Name Annotator OpenAPI specification]: https://github.com/nlpsandbox/nlpsandbox-schemas/blob/develop/openapi/person-name-annotator/openapi.yaml
