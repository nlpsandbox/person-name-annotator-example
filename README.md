...
[![GitHub CI](https://img.shields.io/github/workflow/status/Sage-Bionetworks/nlp-sandbox-person-name-annotator-example/ci.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/person-name-annotator-example/actions)
[![GitHub License](https://img.shields.io/github/license/Sage-Bionetworks/nlp-sandbox-person-name-annotator-example.svg?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&logo=github)](https://github.com/nlpsandbox/person-name-annotator-example/blob/develop/LICENSE)
...
This repository provides a Python-Flask implementation of the [NLP Sandbox
Person Name Annotator]. The Person Name Annotator is one of the first NLP Tools
that can be benchmarked on [nlpsandbox.io]. A Person Name Annotator takes as
input a clinical note and outputs a list of predicted person name annotations
...
This NLP tool relies on two dictionaries of person first and last names to
identify the location of person name strings in a clinical note.
...
The command below starts the Person Name Annotator locally.
...
The Person Name Annotator provides a web interface that you can use to annotate
clinical notes. The address of this interface depends on whether you run the
Person Name Annotator using Docker (production mode) or the Python development
server.
...
This section describes how you can start developing your own Person Name
Annotator that you can then submit for evaluation to the NLP Sandbox.
...
Annotator from scratch](#Creating-a-new-person-name-annotator-from-scratch).
...
### Creating a new Person Name Annotator from scratch

Follow the steps listed below to generate an initial implementation - also
called "stub" - of the Person Name Annotator using one of the many languages and
framework supported by [OpenAPITools/openapi-generator].

1. Download the latest OpenAPI specification of the [NLP Sandbox Person Name
   Annotator].
...
Here is the protocol that we apply to update this example Person Name Annotator
when a new release of the Person Name Annotator specification is available:

1. Create a new branch

       git checkout -b update-to-specification-x.y.z

2. Download the latest OpenAPI specification of the Person Name Annotator.
...
- `Person Name Annotator API version`: The version of the Person Name Annotator
  specification implemented by the tool.
