...
class Note(Model):
    ...
    def __init__(self, text=None, patient_public_id=None, filename=None, type=None, id=None, created_by=None,
                 created_at=None, updated_by=None, updated_at=None):  # noqa: E501
