...
class Note(Model):
    ...
    def __init__(self, text=None, patient_public_id=None, filename=None,
                 type=None, id=None, created_by=None,
                 created_at=None, updated_by=None,
        ...
        :param filename: The filename of this Note.  # noqa: E501
        :type filename: str
    ...
    def text(self, text):
        ...
        if text is None:
            raise ValueError(
                "Invalid value for `text`, must not be `None`")  # noqa: E501
    ...
    @property
    def filename(self):
        """Gets the filename of this Note.

        The filename of the source note  # noqa: E501

        :return: The filename of this Note.
        :rtype: str
        """
    ...
    def filename(self, filename):
        """Sets the filename of this Note.

        The filename of the source note  # noqa: E501

        :param filename: The filename of this Note.
        :type filename: str
        """
