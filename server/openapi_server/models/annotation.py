...
class Annotation(Model):
    ...
    def __init__(self, note_id=None, start=None, length=None, text=None,
                 id=None, created_by=None, created_at=None,
                 updated_by=None, updated_at=None):  # noqa: E501
    ...
    def note_id(self, note_id):
        ...
        if note_id is None:
            raise ValueError(
                "Invalid value for `note_id`, must not be `None`")  # noqa:
            # E501
    ...
    def start(self, start):
        ...
        if start is None:
            raise ValueError(
                "Invalid value for `start`, must not be `None`")  # noqa: E501
    ...
    def length(self, length):
        ...
        if length is None:
            raise ValueError(
                "Invalid value for `length`, must not be `None`")  # noqa: E501
